...
rows:
  - layer: アプリ
    pick: Rails 8＋Hotwire＋tailwindcss-rails＋ViewComponent
  ...
  - layer: 認証
    pick: Rails 8認証ジェネレータ（社内ならGoogle／Entra IDのSSO）
...
rows:
  ...
  - layer: デプロイ
    pick: ECS on Fargate、またはコンテナでオンプレVM
